...
!(function (u) {
          ...
          if (void 0 !== h) {
            if (h.get || h.set) Object.defineProperty(r, t, h);
              ...
              if (
                a &&
                i &&
                (OpenSeadragon.isPlainObject(i) ||
                  (n = OpenSeadragon.isArray(i)))
              ) {
                h = r[t];
                if (n) {
                  n = !1;
            ...
            u.console.warn('Could not copy inherited property "' + t + '".');
        }
    return r;
  };
  u.extend(u, {
    ...
    getElementPosition: function (e) {
      ...
      i = o(
        (e = u.getElement(e)),
        (t = "fixed" === u.getElementStyle(e).position)
      );
      for (; i; ) {
        n.x += e.offsetLeft;
        n.y += e.offsetTop;
    ...
    getElementOffset: function (e) {
      ...
      i =
        i === i.window
          ? i
          : 9 === i.nodeType && (i.defaultView || i.parentWindow);
      return new u.Point(
        n.left + (i.pageXOffset || t.scrollLeft) - (t.clientLeft || 0),
    ...
    setElementTouchActionNone: function (e) {
      void 0 !== (e = u.getElement(e)).style.touchAction
        ? (e.style.touchAction = "none")
        : void 0 !== e.style.msTouchAction && (e.style.msTouchAction = "none");
    },
    setElementPointerEvents: function (e, t) {
      void 0 !== (e = u.getElement(e)).style &&
        void 0 !== e.style.pointerEvents &&
    ...
    indexOf: function (e, t, i) {
      Array.prototype.indexOf
        ...
        : (this.indexOf = function (e, t, i) {
            ...
            for (n = i = i < 0 ? o - Math.abs(i) : i; n < o; n++)
              if (e[n] === t) return n;
            return -1;
          });
    ...
    makeAjaxRequest: function (e, t, i) {
      ...
      l.onreadystatechange = function () {
        if (4 === l.readyState) {
          l.onreadystatechange = function () {};
          (200 <= l.status && l.status < 300) ||
          (0 === l.status && "http:" !== a && "https:" !== a)
            ? t(l)
            : u.isFunction(i)
            ? i(l)
            : u.console.error("AJAX request returned %d: %s", l.status, e);
        }
      };
      var h = s ? "POST" : "GET";
      try {
  ...
  var t = {
      bmp: !(u.Browser = { vendor: u.BROWSERS.UNKNOWN, version: 0, alpha: !0 }),
      jpeg: !0,
      jpg: !0,
      png: !0,
      tif: !1,
  ...
  !(function () {
      ...
      case "Netscape":
        if (window.addEventListener)
          if (0 <= t.indexOf("Edge")) {
            ...
            u.Browser.vendor =
              0 <= t.indexOf("Chrome") ? u.BROWSERS.CHROME : u.BROWSERS.SAFARI;
            u.Browser.version = parseFloat(
              t.substring(
                t.substring(0, t.indexOf("Safari")).lastIndexOf("/") + 1,
                t.indexOf("Safari")
              )
            );
          } else if (
    ...
    u.Browser.alpha = !(
      u.Browser.vendor === u.BROWSERS.CHROME && u.Browser.version < 2
    );
    u.Browser.opacity = !0;
    u.Browser.vendor === u.BROWSERS.IE &&
      u.Browser.version < 11 &&
      u.console.error(
...
!(function (c) {
  ...
  c.MouseTracker = function (e) {
    ...
    this.clickTimeThreshold =
      e.clickTimeThreshold || c.DEFAULT_SETTINGS.clickTimeThreshold;
    this.clickDistThreshold =
      e.clickDistThreshold || c.DEFAULT_SETTINGS.clickDistThreshold;
    this.dblClickTimeThreshold =
      e.dblClickTimeThreshold || c.DEFAULT_SETTINGS.dblClickTimeThreshold;
    this.dblClickDistThreshold =
      e.dblClickDistThreshold || c.DEFAULT_SETTINGS.dblClickDistThreshold;
    ...
    u[this.hash] = {
      ...
      keydown: function (e) {
        !(function (e, t) {
          ...
          ((i && i.preventDefault) ||
            (n.preventDefault && !n.defaultPrevented)) &&
            c.cancelEvent(t);
      ...
      touchstart: function (e) {
        !(function (e, t) {
          ...
          i = c.now();
          s.getLength() > t.touches.length - r &&
            c.console.warn(
    ...
    c.MouseTracker.havePointerEvents &&
      c.setElementPointerEvents(this.element, "auto");
    this.exitHandler &&
      c.console.error(
            ...
            if (!n.tracking) {
              for (i = 0; i < c.MouseTracker.subscribeEvents.length; i++) {
                ...
                c.addEvent(
                  ...
                  t,
                  n[t],
                  t === c.MouseTracker.wheelEventName && {
                    passive: !1,
                    capture: !1,
                  }
                );
  ...
  function i() {
    ...
    d = s;
    for (e = 0; e < r; e++) {
      (i = (t = l[e]).gPoint).direction = Math.atan2(
        i.currentPos.y - t.lastPos.y,
        i.currentPos.x - t.lastPos.x
      );
  ...
  c.MouseTracker.wheelEventName =
    (c.Browser.vendor === c.BROWSERS.IE && 8 < c.Browser.version) ||
  ...
  "DOMMouseScroll" === c.MouseTracker.wheelEventName &&
    c.MouseTracker.subscribeEvents.push("MozMousePixelScroll");
  if (window.PointerEvent) {
    c.MouseTracker.havePointerEvents = !0;
    c.MouseTracker.subscribeEvents.push(
      "pointerenter",
      "pointerleave",
      "pointerover",
      "pointerout",
    ...
    c.MouseTracker.havePointerCapture =
      ((e = document.createElement("div")),
      c.isFunction(e.setPointerCapture) &&
        c.isFunction(e.releasePointerCapture));
    c.MouseTracker.havePointerCapture &&
      c.MouseTracker.subscribeEvents.push(
        "gotpointercapture",
        "lostpointercapture"
    ...
    c.MouseTracker.havePointerCapture =
      ((e = document.createElement("div")),
      c.isFunction(e.setCapture) && c.isFunction(e.releaseCapture));
    c.MouseTracker.havePointerCapture &&
      c.MouseTracker.subscribeEvents.push("losecapture");
    ...
    "ongesturestart" in window &&
      c.MouseTracker.subscribeEvents.push("gesturestart", "gesturechange");
  }
  var e;
  ...
  function g(e, t) {
    ...
    if (c.MouseTracker.havePointerCapture)
      if (c.MouseTracker.havePointerEvents) {
        if (
          !(i = e.getActivePointersListByType(t.type).getById(t.id)) ||
          !i.captured
        )
          return;
        try {
      ...
      r &&
        s(window.top) &&
        c.removeEvent(window.top, i.upName, i.upHandler, !0);
      c.removeEvent(
        c.MouseTracker.captureElement,
        i.moveName,
        i.moveHandler,
        !0
      );
  ...
  function m(e) {
    return c.MouseTracker.havePointerEvents
      ? e.pointerId
      : c.MouseTracker.mousePointerId;
  }
  function v(e) {
    return c.MouseTracker.havePointerEvents
      ? e.pointerType || (c.Browser.vendor === c.BROWSERS.IE ? "mouse" : "")
      : "mouse";
  }
  function f(e) {
  ...
  function S(e, t) {
    ...
    "mousewheel" === c.MouseTracker.wheelEventName
      ? (i.deltaY = -t.wheelDelta / c.DEFAULT_SETTINGS.pixelsPerWheelLine)
      : (i.deltaY = t.detail);
    E(e, i, t);
  }
  function E(e, t, i) {
    ...
    ((r && r.preventDefault) || (o.preventDefault && !o.defaultPrevented)) &&
      c.cancelEvent(i);
  }
  function P(e, t) {
    var i = {
  ...
  function b(e, t) {
    ...
    var n =
      c.MouseTracker.havePointerEvents &&
      "touch" === i.type &&
      c.Browser.vendor !== c.BROWSERS.IE;
    var o = {
      originalEvent: t,
      eventType: "pointerdown",
      pointerType: i.type,
      ...
      (n
        ...
        : (function (e, t) {
            ...
            if (c.MouseTracker.havePointerCapture)
              ...
              i = p(
                e,
                c.MouseTracker.havePointerEvents ? "pointerevent" : t.type
              );
              r &&
                s(window.top) &&
                c.addEvent(window.top, i.upName, i.upHandler, !0);
              c.addEvent(
                c.MouseTracker.captureElement,
                i.upName,
                i.upHandler,
  ...
  function B(e, t) {
    t.eventSource = e;
    t.eventPhase =
      t.originalEvent && void 0 !== t.originalEvent.eventPhase
        ? t.originalEvent.eventPhase
        : 0;
  ...
  function L(e, t, i) {
    ...
    if (t) {
      ...
      c.console.warn("updatePointerCaptured() called on untracked pointer");
  }
  function F(e, t, i) {
    var n,
  ...
  function N(e, t, i, n) {
    ...
    if (0 === n) {
      ...
      if (t.preventGesture || t.defaultPrevented) {
        ...
        t.shouldReleaseCapture = !1;
        t.preventDefault = !0;
        (e.dragHandler || e.dragEndHandler || e.pinchHandler) &&
          c.MouseTracker.gesturePointVelocityTracker.addPoint(e, i);
        if (1 === s.contacts)
          e.pressHandler &&
            !t.preventGesture &&
            e.pressHandler({
          ...
          r.lastPinchDist = r.currentPinchDist =
            r.pinchGPoints[0].currentPos.distanceTo(
              r.pinchGPoints[1].currentPos
            );
          r.lastPinchCenter = r.currentPinchCenter = x(
            r.pinchGPoints[0].currentPos,
            r.pinchGPoints[1].currentPos
          );
        }
      }
    ...
    if (0 === n) {
      ...
      if (!t.preventGesture && !t.defaultPrevented)
        if (h) {
          ...
          t.preventDefault = !0;
          (e.dragHandler || e.dragEndHandler || e.pinchHandler) &&
            c.MouseTracker.gesturePointVelocityTracker.removePoint(e, r);
          if (0 === l.contacts) {
            e.releaseHandler &&
              o &&
              e.releaseHandler({
            ...
            if ((e.clickHandler || e.dblClickHandler) && r.insideElement) {
              s =
                s - r.contactTime <= e.clickTimeThreshold &&
                r.contactPos.distanceTo(o) <= e.clickDistThreshold;
              e.clickHandler &&
                e.clickHandler({
                  eventSource: e,
                  pointerType: r.type,
            ...
            a.lastPinchDist = a.currentPinchDist =
              a.pinchGPoints[0].currentPos.distanceTo(
                a.pinchGPoints[1].currentPos
              );
            a.lastPinchCenter = a.currentPinchCenter = x(
  ...
  o.Control = function (e, t, i) {
    ...
    if (this.anchor === o.ControlAnchor.ABSOLUTE) {
      ...
      this.wrapper.style.left =
        "number" == typeof t.left ? t.left + "px" : t.left;
      this.wrapper.style.height =
        "number" == typeof t.height ? t.height + "px" : t.height;
      ...
      this.anchor === o.ControlAnchor.NONE &&
        (this.wrapper.style.width = this.wrapper.style.height = "100%");
    }
    this.wrapper.appendChild(this.element);
    t.attachToViewer
      ? this.anchor === o.ControlAnchor.TOP_RIGHT ||
        this.anchor === o.ControlAnchor.BOTTOM_RIGHT
  ...
  o.Control.prototype = {
    ...
    setVisible: function (e) {
      this.wrapper.style.display = e
        ? this.anchor === o.ControlAnchor.ABSOLUTE
          ? "block"
          : "inline-block"
        : "none";
    },
    setOpacity: function (e) {
      this.element[o.SIGNAL] && o.Browser.vendor === o.BROWSERS.IE
        ? o.setElementOpacity(this.element, e, !0)
        : o.setElementOpacity(this.wrapper, e, !0);
    },
  };
})(OpenSeadragon);
!(function (o) {
...
!(function (m) {
  ...
  m.Viewer = function (e) {
    ...
    void 0 !== c[this.hash] &&
      m.console.warn("Hash " + this.hash + " has already been used.");
    c[this.hash] = {
    ...
    "" !== e.tabIndex &&
      (this.canvas.tabIndex = void 0 === e.tabIndex ? 0 : e.tabIndex);
    ...
    this.toolbar &&
      (this.toolbar = new m.ControlDock({ element: this.toolbar }));
    ...
    this.world.addHandler("metrics-change", function (e) {
      n.viewport &&
        n.viewport._setContentBounds(
          n.world.getHomeBounds(),
          n.world.getContentFactor()
        );
    });
    ...
    for (t = 0; t < this.customControls.length; t++)
  ...
  m.extend(
    m.Viewer.prototype,
    m.EventSource.prototype,
    m.ControlDock.prototype,
    {
      isOpen: function () {
      ...
      open: function (i, e) {
        ...
        var l = function () {
          if (r + s === n)
            if (r) {
              ...
              if (o.overlays && !o.preserveOverlays)
                for (var t = 0; t < o.overlays.length; t++)
                  o.currentOverlays[t] = h(o, o.overlays[t]);
              o._drawOverlays();
              o._opening = !1;
        ...
        for (var t = 0; t < i.length; t++)
          !(function (i) {
            if (
              void 0 !==
              (i = !m.isPlainObject(i) || !i.tileSource ? { tileSource: i } : i)
                .index
            ) {
              m.console.error(
            ...
            void 0 === i.collectionImmediately &&
              (i.collectionImmediately = !0);
            var n = i.success;
            i.success = function (e) {
              r++;
              if (i.tileSource.overlays)
                for (var t = 0; t < i.tileSource.overlays.length; t++)
                  o.addOverlay(i.tileSource.overlays[t]);
              n && n(e);
              l();
            };
            var t = i.error;
        ...
        if (m.isPlainObject((e = null === e ? {} : e))) {
          ...
          if (t) {
            for (var i = 0; i < this.world.getItemCount(); i++)
              this.world.getItemAt(i)._updateAjaxHeaders(!0);
            this.navigator &&
              this.navigator.setAjaxHeaders(this.ajaxHeaders, !0);
            if (this.referenceStrip && this.referenceStrip.miniViewers)
              for (var n in this.referenceStrip.miniViewers)
                this.referenceStrip.miniViewers[n].setAjaxHeaders(
                  this.ajaxHeaders,
                  !0
                );
          }
        ...
        if (e) {
          ...
          this.toolbar &&
            ...
            (this.element.style.height =
              m.getElementSize(this.element).y -
              m.getElementSize(this.toolbar.element).y +
              "px");
          ...
          c[this.hash].prevElementParent.insertBefore(
            this.element,
            c[this.hash].prevNextSibling
          );
          if (this.toolbar && this.toolbar.element) {
          ...
          var h = function () {
            ...
            ++l < 10 &&
              (e.x !== s.pageScroll.x || e.y !== s.pageScroll.y) &&
      ...
      addTiledImage: function (i) {
        ...
        m.console.assert(
          !i.replace || (-1 < i.index && i.index < this.world.getItemCount()),
          "[Viewer.addTiledImage] if options.replace is used, options.index must be a valid index in Viewer.world"
        );
        var n = this;
        i.replace && (i.replaceItem = n.world.getItemAt(i.index));
        this._hideMessage();
        void 0 === i.placeholderFillStyle &&
          (i.placeholderFillStyle = this.placeholderFillStyle);
        void 0 === i.opacity && (i.opacity = this.opacity);
        void 0 === i.preload && (i.preload = this.preload);
        void 0 === i.compositeOperation &&
          (i.compositeOperation = this.compositeOperation);
        void 0 === i.crossOriginPolicy &&
          (i.crossOriginPolicy = (
            void 0 !== i.tileSource.crossOriginPolicy ? i.tileSource : this
          ).crossOriginPolicy);
        void 0 === i.ajaxWithCredentials &&
          (i.ajaxWithCredentials = this.ajaxWithCredentials);
        void 0 === i.loadTilesWithAjax &&
          (i.loadTilesWithAjax = this.loadTilesWithAjax);
          ...
          !(function (i, n, o, r, s) {
            ...
            setTimeout(function () {
              if ("string" === m.type(n))
                (n = new m.TileSource({
                  url: n,
                  crossOriginPolicy: (void 0 !== o.crossOriginPolicy ? o : i)
                    .crossOriginPolicy,
                ...
                void 0 !== n.crossOriginPolicy ||
                  (void 0 === o.crossOriginPolicy &&
                    void 0 === i.crossOriginPolicy) ||
                  (n.crossOriginPolicy = (
                    void 0 !== o.crossOriginPolicy ? o : i
                  ).crossOriginPolicy);
                void 0 === n.ajaxWithCredentials &&
                  (n.ajaxWithCredentials = i.ajaxWithCredentials);
          ...
          for (; n._loadQueue.length && (e = n._loadQueue[0]).tileSource; ) {
            ...
            t = new m.TiledImage({
              ...
              subPixelRoundingForTransparency:
                n.subPixelRoundingForTransparency,
            });
        ...
        if (this.showSequenceControl) {
          ...
          this.previousButton = new m.Button({
            element: this.previousButton
              ? m.getElement(this.previousButton)
              : null,
            clickTimeThreshold: this.clickTimeThreshold,
            clickDistThreshold: this.clickDistThreshold,
          ...
          if (r) {
            ...
            this.toolbar
              ...
              : this.addControl(this.pagingControl, {
                  anchor:
                    this.sequenceControlAnchor || m.ControlAnchor.TOP_LEFT,
                });
          }
        }
        return this;
            ...
            p.push(
              (this.zoomOutButton = new m.Button({
                element: this.zoomOutButton
                  ? m.getElement(this.zoomOutButton)
                  : null,
                clickTimeThreshold: this.clickTimeThreshold,
                clickDistThreshold: this.clickDistThreshold,
            ...
            p.push(
              (this.fullPageButton = new m.Button({
                element: this.fullPageButton
                  ? m.getElement(this.fullPageButton)
                  : null,
                clickTimeThreshold: this.clickTimeThreshold,
                clickDistThreshold: this.clickDistThreshold,
            ...
            p.push(
              (this.rotateLeftButton = new m.Button({
                element: this.rotateLeftButton
                  ? m.getElement(this.rotateLeftButton)
                  : null,
                clickTimeThreshold: this.clickTimeThreshold,
                clickDistThreshold: this.clickDistThreshold,
            ...
            p.push(
              (this.rotateRightButton = new m.Button({
                element: this.rotateRightButton
                  ? m.getElement(this.rotateRightButton)
                  : null,
                clickTimeThreshold: this.clickTimeThreshold,
                clickDistThreshold: this.clickDistThreshold,
      ...
      addOverlay: function (e, t, i, n) {
        i = m.isPlainObject(e)
          ? e
          : { element: e, location: t, placement: i, onDraw: n };
      ...
      getOverlayById: function (e) {
        e = m.getElement(e);
        return 0 <= (e = s(this.currentOverlays, e))
          ? this.currentOverlays[e]
          : null;
      },
  ...
  function r(e) {
    e = m.getElement(e);
    return new m.Point(
      0 === e.clientWidth ? 1 : e.clientWidth,
      0 === e.clientHeight ? 1 : e.clientHeight
    );
  }
  function h(e, t) {
    ...
    if (t.element) i = m.getElement(t.element);
      ...
      var n =
        t.id || "openseadragon-overlay-" + Math.floor(1e7 * Math.random());
      (i = m.getElement(t.id)) ||
        ((i = document.createElement("a")).href = "#/overlay/" + n);
      i.id = n;
    ...
    m.requestAnimationFrame(function () {
      !(function (e) {
        ...
        if (e.controlsShouldFade) {
          ...
          i = Math.min(1, i);
          i = Math.max(0, i);
          for (n = e.controls.length - 1; 0 <= n; n--)
            e.controls[n].autoFade && e.controls[n].setOpacity(i);
          0 < i && l(e);
        }
      })(e);
    });
  ...
  function p(e) {
    ...
    if (t.preventDefaultAction || e.ctrl || e.alt || e.meta)
      e.preventDefault = !1;
    else
      switch (e.keyCode) {
        case 38:
            ...
            e.shift
              ...
              : this.viewport.panBy(
                  this.viewport.deltaPointsFromPixels(
                    new m.Point(0, -this.pixelsPerArrowPress)
                  )
                );
        ...
        case 37:
          if (!t.preventHorizontalPan) {
            this.viewport.panBy(
              this.viewport.deltaPointsFromPixels(
                new m.Point(-this.pixelsPerArrowPress, 0)
              )
            );
            this.viewport.applyConstraints();
          }
        ...
        case 87:
          if (!t.preventVerticalPan) {
            e.shift
              ? this.viewport.zoomBy(1.1)
              : this.viewport.panBy(
                  this.viewport.deltaPointsFromPixels(new m.Point(0, -40))
                );
            this.viewport.applyConstraints();
          }
          e.preventDefault = !0;
        ...
        case 65:
          if (!t.preventHorizontalPan) {
            this.viewport.panBy(
              this.viewport.deltaPointsFromPixels(new m.Point(-40, 0))
            );
            this.viewport.applyConstraints();
          }
          e.preventDefault = !0;
  ...
  function y(e) {
    ...
    if (!t.preventDefaultAction && this.viewport && e.quick) {
      if (
        !0 === (t = this.gestureSettingsByDeviceType(e.pointerType)).clickToZoom
      ) {
        this.viewport.zoomBy(
          e.shift ? 1 / this.zoomPerClick : this.zoomPerClick,
          t.zoomToRefPoint ? this.viewport.pointFromPixel(e.position, !0) : null
        );
        this.viewport.applyConstraints();
      }
  ...
  function w(e) {
    ...
    if (
      ...
      this.viewport &&
      (t = this.gestureSettingsByDeviceType(e.pointerType)).dblClickToZoom
    ) {
      this.viewport.zoomBy(
        e.shift ? 1 / this.zoomPerClick : this.zoomPerClick,
        t.zoomToRefPoint ? this.viewport.pointFromPixel(e.position, !0) : null
  ...
  function x(e) {
    ...
    if (!i.preventDefaultAction && this.viewport) {
      if (
        !c[this.hash].draggingToZoom &&
        t.flickEnabled &&
        e.speed >= t.flickMinSpeed
      ) {
        var n = 0;
        this.panHorizontal &&
          (n = t.flickMomentum * e.speed * Math.cos(e.direction));
        i = 0;
        this.panVertical &&
          (i = t.flickMomentum * e.speed * Math.sin(e.direction));
    ...
    t.dblClickDragToZoom &&
      !0 === c[this.hash].draggingToZoom &&
      (c[this.hash].draggingToZoom = !1);
  }
  function S(e) {
  ...
  function P(e) {
    ...
    if (this.gestureSettingsByDeviceType(e.pointerType).dblClickDragToZoom) {
      ...
      e = m.now();
      if (null !== t) {
        e - t < this.dblClickTimeThreshold &&
          (c[this.hash].draggingToZoom = !0);
        c[this.hash].lastClickTime = null;
      }
    }
  }
  ...
  function b(e) {
    ...
    if (this.viewport) {
      if (
        (o = this.gestureSettingsByDeviceType(e.pointerType)).pinchToZoom &&
        (!n.preventDefaultPanAction || !n.preventDefaultZoomAction)
      ) {
        ...
        n.preventDefaultZoomAction ||
          this.viewport.zoomBy(e.distance / e.lastDistance, t, !0);
        this.viewport.applyConstraints();
      }
      if (o.pinchRotate && !n.preventDefaultRotateAction) {
        var o = Math.atan2(
          e.gesturePoints[0].currentPos.y - e.gesturePoints[1].currentPos.y,
          e.gesturePoints[0].currentPos.x - e.gesturePoints[1].currentPos.x
        );
        n = Math.atan2(
        ...
        this.viewport.rotateTo(
          this.viewport.getRotation(!0) + (o - n) * (180 / Math.PI),
          t,
          !0
        );
      }
    ...
    if ((n = m.now()) - this._lastScrollTime > this.minScrollDeltaTime) {
      ...
      if (!t.preventDefaultAction && this.viewport) {
        this.viewport.flipped &&
          (e.position.x = this.viewport.getContainerSize().x - e.position.x);
        if (
          (i = this.gestureSettingsByDeviceType(e.pointerType)).scrollToZoom
        ) {
          ...
          c[e.hash].needsResize &&
            (function (e, t) {
              ...
              if (e.preserveImageSizeOnResize)
                r = c[e.hash].prevContainerSize.x / t.x;
              else {
                var s = new m.Point(0, 0);
                o = new m.Point(
                  c[e.hash].prevContainerSize.x,
                  c[e.hash].prevContainerSize.y
                ).distanceTo(s);
  ...
  function V() {
    this.isFullPage() && !m.isFullScreen()
      ? this.setFullPage(!1)
...
!(function (r) {
  r.Navigator = function (i) {
    ...
    if (i.element || i.id) {
      ...
      if (i.position)
        if ("BOTTOM_RIGHT" === i.position)
          i.controlOptions.anchor = r.ControlAnchor.BOTTOM_RIGHT;
        else if ("BOTTOM_LEFT" === i.position)
          i.controlOptions.anchor = r.ControlAnchor.BOTTOM_LEFT;
        else if ("TOP_RIGHT" === i.position)
          i.controlOptions.anchor = r.ControlAnchor.TOP_RIGHT;
        else if ("TOP_LEFT" === i.position)
          i.controlOptions.anchor = r.ControlAnchor.TOP_LEFT;
    ...
    this.totalBorderWidths = new r.Point(
      2 * this.borderWidth,
      2 * this.borderWidth
    ).minus(this.fudge);
  ...
  r.extend(r.Navigator.prototype, r.EventSource.prototype, r.Viewer.prototype, {
    updateSize: function () {
      if (this.viewport) {
        var e = new r.Point(
          ...
          0 === this.container.clientHeight ? 1 : this.container.clientHeight
        );
    ...
    update: function (e) {
      ...
      if (e && this.viewport) {
        ...
        i = this.viewport
          .pixelFromPointNoRotate(i.getBottomRight(), !1)
    ...
    _getMatchingItem: function (e) {
      ...
      var i;
      for (var n = 0; n < t; n++)
        if ((i = this.world.getItemAt(n))._originalForNavigator === e) return i;
      return null;
    },
  ...
  function s(e) {
    ...
    if (
      ...
      this.panVertical
        ? this.panHorizontal || (e.x = this.viewer.viewport.getCenter(!0).x)
        : (e.y = this.viewer.viewport.getCenter(!0).y);
...
!(function (h) {
  h.TileSource = function (e, t, i, n, o, r) {
    ...
    if (this.url) {
      ...
      this.maxLevel =
        void 0 !== l.maxLevel && null !== l.maxLevel
          ? l.maxLevel
          : l.width && l.height
          ? Math.ceil(Math.log(Math.max(l.width, l.height)) / Math.log(2))
          : 0;
  ...
  h.TileSource.prototype = {
    ...
    getClosestLevel: function () {
      ...
      for (
        e = this.minLevel + 1;
        e <= this.maxLevel && !(1 < (t = this.getNumTiles(e)).x || 1 < t.y);
        e++
      );
      return e - 1;
    },
    ...
    getImageInfo: function (n) {
      var t,
        ...
        s = this;
      n &&
        -1 < (r = (o = (e = n.split("/"))[e.length - 1]).lastIndexOf(".")) &&
        (e[e.length - 1] = o.slice(0, r));
      var a = null;
      ...
      t = function (e) {
        ...
        if (t) {
          void 0 ===
            (i = t.prototype.configure.apply(s, [e, n, a]))
              .ajaxWithCredentials &&
            (i.ajaxWithCredentials = s.ajaxWithCredentials);
          i = new t(i);
          s.ready = !0;
        ...
        h.makeAjaxRequest({
          ...
          error: function (e, t) {
            ...
            try {
              ...
              i =
                (void 0 !== t && t.toString ? t.toString() : "Unknown error") +
      ...
      if (t.loadWithAjax)
        i.request = h.makeAjaxRequest({
          ...
          success: function (t) {
            ...
            0 === i.size
              ? r("Empty image response.")
              : (o.src = (window.URL || window.webkitURL).createObjectURL(i));
          },
          error: function (e) {
  ...
  h.TileSource.determineType = function (e, t, i) {
    for (var n in OpenSeadragon)
      if (
        n.match(/.+TileSource$/) &&
        h.isFunction(OpenSeadragon[n]) &&
        h.isFunction(OpenSeadragon[n].prototype.supports) &&
        OpenSeadragon[n].prototype.supports.call(e, t, i)
      )
...
!(function (p) {
  ...
  p.extend(p.DziTileSource.prototype, p.TileSource.prototype, {
    ...
    configure: function (e, t, i) {
        ...
        p.isPlainObject(e)
          ...
          : function (e, t) {
              if (!t || !t.documentElement)
                throw new Error(p.getString("Errors.Xml"));
              var i,
                n,
                o,
                r,
              ...
              if ("Image" === l)
                try {
                  void 0 === (r = a.getElementsByTagName("Size")[0]) &&
                    (r = a.getElementsByTagNameNS(h, "Size")[0]);
                  t = {
                    Image: {
                  ...
                  if (!p.imageFormatSupported(t.Image.Format))
                    throw new Error(
                      p.getString(
                        "Errors.ImageFormat",
                        t.Image.Format.toUpperCase()
                      )
                    );
                  void 0 === (i = a.getElementsByTagName("DisplayRect")) &&
                    (i = a.getElementsByTagNameNS(h, "DisplayRect")[0]);
                  for (s = 0; s < i.length; s++) {
                    n = i[s];
                    void 0 === (o = n.getElementsByTagName("Rect")[0]) &&
                      (o = n.getElementsByTagNameNS(h, "Rect")[0]);
                    c.push({
                      Rect: {
                  ...
                  throw e instanceof Error
                    ? e
                    : new Error(p.getString("Errors.Dzi"));
                }
              else {
                if ("Collection" === l)
                  throw new Error(p.getString("Errors.Dzc"));
                if ("Error" === l) {
      ...
      if (t && !e.tilesUrl) {
        e.tilesUrl = t.replace(
          /([^/]+?)(\.(dzi|xml|js)?(\?[^/]*)?)?\/?$/,
          "$1_files/"
        );
        -1 !== t.search(/\.(dzi|xml|js)\?/)
          ? (e.queryParams = t.match(/\?.*/))
          : (e.queryParams = "");
      }
      return e;
    },
...
!(function (h) {
  ...
  h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
    ...
    configure: function (e, t, i) {
      ...
      var s = (function (e) {
        if (!e || !e.documentElement)
          throw new Error(h.getString("Errors.Xml"));
            ...
            !(function e(t, i, n) {
              ...
              if (3 === t.nodeType && n) {
                ...
                for (o = 0; o < t.childNodes.length; o++)
                  e(t.childNodes[o], i, t.nodeName);
            })(t, (e = {}));
            return e;
          } catch (e) {
            throw e instanceof Error
              ? e
              : new Error(h.getString("Errors.IIIF"));
          }
    ...
    getTileWidth: function (e) {
      if (this.emulateLegacyImagePyramid)
        return h.TileSource.prototype.getTileWidth.call(this, e);
      e = Math.pow(2, this.maxLevel - e);
      return this.tileSizePerScaleFactor && this.tileSizePerScaleFactor[e]
        ? this.tileSizePerScaleFactor[e].width
        : this._tileWidth;
    },
    getTileHeight: function (e) {
      if (this.emulateLegacyImagePyramid)
        return h.TileSource.prototype.getTileHeight.call(this, e);
      e = Math.pow(2, this.maxLevel - e);
      return this.tileSizePerScaleFactor && this.tileSizePerScaleFactor[e]
        ? this.tileSizePerScaleFactor[e].height
        : this._tileHeight;
    },
    getLevelScale: function (e) {
      if (this.emulateLegacyImagePyramid) {
        var t = NaN;
        return (t =
          0 < this.levels.length && e >= this.minLevel && e <= this.maxLevel
    ...
    getNumTiles: function (e) {
      if (this.emulateLegacyImagePyramid)
        return this.getLevelScale(e) ? new h.Point(1, 1) : new h.Point(0, 0);
      if (this.levelSizes) {
    ...
    getTileUrl: function (e, t, i) {
      ...
      if (o < c && r < u) {
        h =
          2 === this.version && o === this.width
            ? "full"
            : 3 === this.version && o === this.width && r === this.height
            ? "max"
            : 3 === this.version
            ? o + "," + r
            : o + ",";
        ...
        s =
          0 === t && 0 === i && a === this.width && l === this.height
            ? "full"
            : [e, d, a, l].join(",");
        c = Math.min(c, o - t * c);
        u = Math.min(u, r - i * u);
        h =
          2 === this.version && c === this.width
            ? "full"
            : 3 === this.version && c === this.width && u === this.height
            ? "max"
            : 3 === this.version
            ? c + "," + u
            : c + ",";
  ...
  function c(e) {
    ...
    2 === e.version &&
      ...
      (t = -1 !== e.profile[1].supports.indexOf("sizeByW"));
    3 === e.version &&
      e.extraFeatures &&
      (t = -1 !== e.extraFeatures.indexOf("sizeByWh"));
    return !i || t;
  }
  function u(e) {
    var t = [];
    for (var i = 0; i < e.sizes.length; i++)
      t.push({
        url:
          e._id +
          "/full/" +
...
!(function (s) {
  s.OsmTileSource = function (e, t, i, n, o) {
    ...
    if (
      !(r = s.isPlainObject(e)
        ? e
        : { width: e, height: t, tileSize: i, tileOverlap: n, tilesUrl: o })
        .width ||
      !r.height
    ) {
      r.width = 65572864;
...
!(function (a) {
  a.LegacyTileSource = function (e) {
    var t, i, n;
    (t = a.isArray(e)
      ? { type: "legacy-image-pyramid", levels: e }
      : t).levels = (function (e) {
      var t,
        i,
        n = [];
      for (i = 0; i < e.length; i++)
        (t = e[i]).height && t.width && t.url
          ? n.push({
              url: t.url,
  ...
  a.extend(a.LegacyTileSource.prototype, a.TileSource.prototype, {
    supports: function (e, t) {
      return (
        ...
        (e.documentElement &&
          "legacy-image-pyramid" === e.documentElement.getAttribute("type"))
      );
    },
    configure: function (e, t, i) {
...
!(function (a) {
  ...
  a.extend(a.ImageTileSource.prototype, a.TileSource.prototype, {
    ...
    getLevelScale: function (e) {
      var t = NaN;
      return (t =
        e >= this.minLevel && e <= this.maxLevel
          ? this.levels[e].width / this.levels[this.maxLevel].width
          : t);
    },
    getNumTiles: function (e) {
    ...
    getTileUrl: function (e, t, i) {
      var n = null;
      return (n =
        e >= this.minLevel && e <= this.maxLevel ? this.levels[e].url : n);
    },
...
!(function (i) {
  ...
  i.Button = function (e) {
    ...
    if (!e.element) {
      ...
      i.Browser.vendor === i.BROWSERS.FIREFOX &&
        i.Browser.version < 3 &&
        (this.imgGroup.style.top =
          this.imgHover.style.top =
          this.imgDown.style.top =
    ...
    this.tracker = new i.MouseTracker({
      ...
      leaveHandler: function (e) {
        ...
        e.insideElementPressed &&
          t.raiseEvent("exit", { originalEvent: e.originalEvent });
      },
  ...
  o.ButtonGroup = function (e) {
    ...
    this.tracker = new o.MouseTracker({
      ...
      leaveHandler: function (e) {
        var t;
        if (!e.insideElementPressed)
          for (t = 0; t < n.buttons.length; t++) n.buttons[t].notifyGroupExit();
      },
    });
  };
...
!(function (v) {
  ...
  v.Rect.prototype = {
    ...
    getBottomRight: function () {
      return new v.Point(this.x + this.width, this.y + this.height).rotate(
        this.degrees,
        this.getTopLeft()
      );
    },
    getTopRight: function () {
      return new v.Point(this.x + this.width, this.y).rotate(
        this.degrees,
        this.getTopLeft()
      );
    },
    getBottomLeft: function () {
      return new v.Point(this.x, this.y + this.height).rotate(
        this.degrees,
        this.getTopLeft()
      );
    },
...
!(function (h) {
  ...
  h.ReferenceStrip = function (e) {
    ...
    if (e.width && e.height) {
      ...
      this.element.style.width =
        r.x * e.sizeRatio * o.tileSources.length +
        12 * o.tileSources.length +
        "px";
      this.element.style.height = r.y * e.sizeRatio + "px";
      o.addControl(this.element, { anchor: h.ControlAnchor.BOTTOM_LEFT });
    } else {
      this.element.style.height =
        r.y * e.sizeRatio * o.tileSources.length +
        12 * o.tileSources.length +
        "px";
    ...
    setFocus: function (e) {
      ...
      if (this.currentSelected !== i) {
        ...
        if ("horizontal" === this.scroll) {
          if (
            (t = Number(e) * (this.panelWidth + 3)) >
            s + n.x - this.panelWidth
          ) {
            t = Math.min(t, o - n.x);
          ...
          (t = Number(e) * (this.panelHeight + 3)) >
          a + n.y - this.panelHeight
        ) {
          t = Math.min(t, r - n.y);
    ...
    if (e.quick) {
      e =
        "horizontal" === this.scroll
          ? Math.floor(e.position.x / (this.panelWidth + 4))
  ...
  function u(e, t, i) {
    ...
    o = Math.ceil(t / n) + 5;
    for (
      s = o = (o = (r = Math.ceil((Math.abs(i) + t) / n) + 1) - o) < 0 ? 0 : o;
      s < r && s < e.panels.length;
      s++
    )
      if (!(a = e.panels[s]).activePanel) {
        var l = e.viewer.tileSources[s];
        l = l.referenceStripThumbnailUrl
          ? { type: "image", url: l.referenceStripThumbnailUrl }
          : l;
        l = new h.Viewer({
          id: a.id,
          tileSources: [l],
  ...
  function p(e) {
    e = e.eventSource.element;
    "horizontal" === this.scroll
      ? (e.style.marginBottom = "-" + h.getElementSize(e).y / 2 + "px")
      : (e.style.marginLeft = "-" + h.getElementSize(e).x / 2 + "px");
  }
  function g(e) {
...
!(function (o) {
  o.Spring = function (e) {
    ...
    o.console.assert(
      "number" == typeof e.springStiffness && 0 !== e.springStiffness,
      "[OpenSeadragon.Spring] options.springStiffness must be a non-zero number"
    );
    o.console.assert(
      "number" == typeof e.animationTime && 0 <= e.animationTime,
        ...
        this.current.time >= this.target.time
          ...
          : e +
            (t - e) *
              ...
              (1 - Math.exp(n * -i)) / (1 - Math.exp(-n)));
      var i;
      var n = this.current.value;
      this._exponential
        ? (this.current.value = Math.exp(i))
...
!(function (n) {
  n.ImageJob = function (e) {
    n.extend(
      !0,
      this,
      { timeout: n.DEFAULT_SETTINGS.timeout, jobId: null, tries: 0 },
      e
    );
    this.data = null;
    this.userData = {};
    ...
    start: function () {
      ...
      this.jobId = window.setTimeout(function () {
        e.finish(
          null,
          null,
          "Image load exceeded timeout (" + e.timeout + " ms)"
        );
      }, this.timeout);
      this.abort = function () {
  ...
  n.ImageLoader = function (e) {
    n.extend(
      ...
      this,
      {
        jobLimit: n.DEFAULT_SETTINGS.imageLoaderLimit,
  ...
  n.ImageLoader.prototype = {
    addJob: function (t) {
      if (!t.source) {
        ...
        t.source = {
          downloadTileStart: e.downloadTileStart,
          downloadTileAbort: e.downloadTileAbort,
        };
      }
      var i = this,
        e = {
          ...
          callback: function (e) {
            !(function (e, t, i) {
              "" !== t.errorMsg &&
                ...
                t.tries < 1 + e.tileRetryMax &&
                e.failedTiles.push(t);
              var n;
              e.jobsInProgress--;
              if (
...
!(function (r) {
  ...
  r.Overlay.prototype = {
    _init: function (e) {
      ...
      this.placement =
        void 0 === e.placement ? r.Placement.TOP_LEFT : e.placement;
    ...
    _getOverlayPositionAndSize: function (e) {
      ...
      if (
        e.getRotation(!0) &&
        this.rotationMode !== r.OverlayRotationMode.NO_ROTATION
      )
        if (
          this.rotationMode === r.OverlayRotationMode.BOUNDING_BOX &&
          null !== this.width &&
          null !== this.height
        ) {
    ...
    _getSizeInPixels: function (e) {
      ...
      if (null !== this.width || null !== this.height) {
        var n = e.deltaPixelsFromPointsNoRotate(
          new r.Point(this.width || 0, this.height || 0),
          !0
        );
    ...
    _getPlacementPoint: function (e) {
      ...
      var i = r.Placement.properties[this.placement];
      if (i) {
        i.isHorizontallyCentered
          ? (t.x += e.width / 2)
          : i.isRight && (t.x += e.width);
        i.isVerticallyCentered
          ? (t.y += e.height / 2)
          : i.isBottom && (t.y += e.height);
      }
      return t;
    },
    ...
    _adjustBoundsForRotation: function (e, t) {
      if (
        !e ||
        0 === e.getRotation(!0) ||
        this.rotationMode === r.OverlayRotationMode.EXACT
      )
        return t;
      if (this.rotationMode !== r.OverlayRotationMode.BOUNDING_BOX)
        return t.rotate(-e.getRotation(!0), this._getPlacementPoint(t));
      if (null === this.width || null === this.height) return t;
      t = this._getOverlayPositionAndSize(e);
      return e.viewerElementToViewportRectangle(
        new r.Rect(t.position.x, t.position.y, t.size.x, t.size.y)
      );
    },
  };
})(OpenSeadragon);
!(function (a) {
  a.Drawer = function (e) {
    ...
    this.debugGridColor =
      "string" == typeof e.debugGridColor
        ? [e.debugGridColor]
    ...
    this.useCanvas =
      a.supportsCanvas && (!this.viewer || this.viewer.useCanvas);
  ...
  a.Drawer.prototype = {
    ...
    viewportToDrawerRectangle: function (e) {
      ...
      return new a.Rect(
        t.x * a.pixelDensityRatio,
        t.y * a.pixelDensityRatio,
        e.x * a.pixelDensityRatio,
        e.y * a.pixelDensityRatio
      );
    },
    ...
    blendSketch: function (e, t, i, n) {
      var o = e;
      a.isPlainObject(o) ||
        (o = { opacity: e, scale: t, translate: i, compositeOperation: n });
      if (this.useCanvas && this.sketchCanvas) {
        ...
        if (r) {
          ...
          r.x + r.width > this.canvas.width &&
            (r.width = this.canvas.width - r.x);
          if (r.y < 0) {
            r.height += r.y;
            r.y = 0;
          }
          r.y + r.height > this.canvas.height &&
            (r.height = this.canvas.height - r.y);
          ...
          this.context.drawImage(
            ...
            e.x - n * t,
            e.y - r * t,
            (this.canvas.width + 2 * n) * t,
            (this.canvas.height + 2 * r) * t,
            -n,
            -r,
            this.canvas.width + 2 * n,
    ...
    drawDebugInfo: function (e, t, i, n) {
      if (this.useCanvas) {
        var o =
          this.viewer.world.getIndexOfItem(n) % this.debugGridColor.length;
        var r = this.context;
        r.save();
        ...
        n.getRotation(!0) % 360 != 0 &&
          this._offsetForRotation({
            degrees: n.getRotation(!0),
            point: n.viewport.pixelFromPointNoRotate(
              n._getRotationPoint(!0),
              !0
            ),
          });
        n.viewport.getRotation(!0) % 360 == 0 &&
          n.getRotation(!0) % 360 == 0 &&
          n._drawer.viewer.viewport.getFlip() &&
          n._drawer._flip();
        r.strokeRect(
          e.position.x * a.pixelDensityRatio,
          e.position.y * a.pixelDensityRatio,
          e.size.x * a.pixelDensityRatio,
          e.size.y * a.pixelDensityRatio
        );
        ...
        if (0 === e.x && 0 === e.y) {
          r.fillText(
            ...
            e.position.x * a.pixelDensityRatio,
            (e.position.y - 30) * a.pixelDensityRatio
          );
          r.fillText(
            "Pan: " + this.viewport.getBounds().toString(),
            e.position.x * a.pixelDensityRatio,
            (e.position.y - 20) * a.pixelDensityRatio
          );
        }
        r.fillText(
          "Level: " + e.level,
          (e.position.x + 10) * a.pixelDensityRatio,
          (e.position.y + 20) * a.pixelDensityRatio
        );
        r.fillText(
          "Column: " + e.x,
        ...
        r.fillText(
          "Row: " + e.y,
          (e.position.x + 10) * a.pixelDensityRatio,
          (e.position.y + 40) * a.pixelDensityRatio
        );
        r.fillText(
          "Order: " + i + " of " + t,
          (e.position.x + 10) * a.pixelDensityRatio,
          (e.position.y + 50) * a.pixelDensityRatio
        );
        r.fillText(
          "Size: " + e.size.toString(),
          (e.position.x + 10) * a.pixelDensityRatio,
          (e.position.y + 60) * a.pixelDensityRatio
        );
        r.fillText(
          "Position: " + e.position.toString(),
          (e.position.x + 10) * a.pixelDensityRatio,
          (e.position.y + 70) * a.pixelDensityRatio
        );
        this.viewport.getRotation(!0) % 360 != 0 &&
    ...
    debugRect: function (e) {
      if (this.useCanvas) {
        ...
        t.strokeRect(
          e.x * a.pixelDensityRatio,
          e.y * a.pixelDensityRatio,
          e.width * a.pixelDensityRatio,
          e.height * a.pixelDensityRatio
        );
        t.restore();
      }
    },
    ...
    _offsetForRotation: function (e) {
      var t = e.point
        ? e.point.times(a.pixelDensityRatio)
...
!(function (h) {
  h.Viewport = function (e) {
    ...
    if (
      (e =
        t.length && t[0] instanceof h.Point
          ? { containerSize: t[0], contentSize: t[1], config: t[2] }
          : e).config
    ) {
      h.extend(!0, e, e.config);
      delete e.config;
    }
    this._margins = h.extend(
    ...
    this.centerSpringX = new h.Spring({
      initial: 0,
      springStiffness: this.springStiffness,
      animationTime: this.animationTime,
    });
    this.centerSpringY = new h.Spring({
      initial: 0,
      springStiffness: this.springStiffness,
      animationTime: this.animationTime,
    });
    this.zoomSpring = new h.Spring({
      exponential: !0,
      initial: 1,
      springStiffness: this.springStiffness,
      animationTime: this.animationTime,
    });
    this.degreesSpring = new h.Spring({
      initial: e.initialDegrees,
      springStiffness: this.springStiffness,
      animationTime: this.animationTime,
    });
  ...
  h.Viewport.prototype = {
    ...
    getHomeZoom: function () {
      ...
      return (
        (this.homeFillsViewer ? (1 <= e ? e : 1) : 1 <= e ? 1 : e) /
    ...
    _applyBoundaryConstraints: function (e) {
      ...
      var i = this.viewportToViewerElementRectangle(
      ...
      if (!this.wrapHorizontal) {
        ...
        a =
          t.width > i.width
            ? this.visibilityRatio * i.width
            : this.visibilityRatio * t.width;
        r = i.x - r + a;
        s = s - t.x - a;
        if (a > i.width) {
          t.x += (r + s) / 2;
      ...
      if (!this.wrapVertical) {
        ...
        r =
          t.height > i.height
            ? this.visibilityRatio * i.height
            : this.visibilityRatio * t.height;
        l = i.y - l + r;
        s = s - t.y - r;
        if (r > i.height) {
          t.y += (l + s) / 2;
    ...
    zoomTo: function (e, t, i) {
      var n = this;
      this.zoomPoint =
        t instanceof h.Point && !isNaN(t.x) && !isNaN(t.y) ? t : null;
      i
    ...
    rotateTo: function (e, t, i) {
      ...
      if (
        this.degreesSpring.target.value === e &&
    ...
    resize: function (e, t) {
      ...
      this.viewer &&
        this.viewer.raiseEvent("resize", { newContainerSize: e, maintain: t });
    ...
    _updateContainerInnerSize: function () {
      this._containerInnerSize = new h.Point(
        Math.max(
          1,
    ...
    _pixelFromPoint: function (e, t) {
      return this._pixelFromPointNoRotate(
        e.rotate(this.getRotation(!0), this.getCenter(!0)),
        t
      );
    },
      ...
      if (this.viewer) {
        ...
        if (1 < i)
          ...
          return this.viewer.world
            .getItemAt(0)
            .viewportToImageCoordinates(e, t, !0);
      }
      return this._viewportToImageDelta(
        e - this._contentBoundsNoRotate.x,
        t - this._contentBoundsNoRotate.y
      );
    },
    ...
    imageToViewportCoordinates: function (e, t) {
      ...
      if (this.viewer) {
        ...
        if (1 < i)
          ...
          return this.viewer.world
            .getItemAt(0)
            .imageToViewportCoordinates(e, t, !0);
      }
    ...
    imageToViewportRectangle: function (e, t, i, n) {
      ...
      if (this.viewer) {
        ...
        if (1 < r)
          ...
          return this.viewer.world
            .getItemAt(0)
            .imageToViewportRectangle(e, t, i, n, !0);
      }
    ...
    viewportToImageRectangle: function (e, t, i, n) {
      ...
      if (this.viewer) {
        ...
        if (1 < r)
          ...
          return this.viewer.world
            .getItemAt(0)
            .viewportToImageRectangle(e, t, i, n, !0);
      }
    ...
    imageToWindowCoordinates: function (e) {
      ...
      return this.imageToViewerElementCoordinates(e).plus(
        h.getElementPosition(this.viewer.element)
      );
    },
    ...
    viewerElementToViewportRectangle: function (e) {
      return h.Rect.fromSummits(
        this.pointFromPixel(e.getTopLeft(), !0),
        this.pointFromPixel(e.getTopRight(), !0),
        this.pointFromPixel(e.getBottomLeft(), !0)
      );
    },
    viewportToViewerElementRectangle: function (e) {
      return h.Rect.fromSummits(
        this.pixelFromPoint(e.getTopLeft(), !0),
        this.pixelFromPoint(e.getTopRight(), !0),
        this.pixelFromPoint(e.getBottomLeft(), !0)
      );
    },
    ...
    viewportToWindowCoordinates: function (e) {
      ...
      return this.viewportToViewerElementCoordinates(e).plus(
        h.getElementPosition(this.viewer.element)
      );
    },
    viewportToImageZoom: function (e) {
      ...
      return (
        e *
        ((this._containerInnerSize.x / t) * this._contentBoundsNoRotate.width)
      );
    },
...
!(function (y) {
  y.TiledImage = function (e) {
    ...
    y.console.assert(
      !e.clip || e.clip instanceof y.Rect,
    ...
    y.extend(
      ...
      this,
      {
        ...
        subPixelRoundingForTransparency:
          y.DEFAULT_SETTINGS.subPixelRoundingForTransparency,
      },
      e
    );
  ...
  y.extend(y.TiledImage.prototype, y.EventSource.prototype, {
    ...
    getClippedBounds: function (e) {
      ...
      if (this._clip) {
        var i =
          (e ? this._worldWidthCurrent : this._worldWidthTarget) /
    ...
    getTileBounds: function (e, t, i) {
      ...
      e.x += (t - o) / n.x;
      e.y +=
        (this._worldHeightCurrent / this._worldWidthCurrent) * ((i - r) / n.y);
      return e;
    },
    ...
    _viewportToImageDelta: function (e, t, i) {
      ...
      return new y.Point(
        e * (this.source.dimensions.x / i),
        t * ((this.source.dimensions.y * this.contentAspectX) / i)
      );
    },
    ...
    _viewportToTiledImageRectangle: function (e) {
      ...
      return new y.Rect(
        (e.x - this._xSpring.current.value) / t,
        (e.y - this._ySpring.current.value) / t,
        e.width / t,
        e.height / t,
        e.degrees
      );
    ...
    fitBounds: function (e, t, i) {
      ...
      if (e.getAspectRatio() > o) {
        ...
        n.isHorizontallyCentered
          ? (t = (e.width - e.height * o) / 2)
          : n.isRight && (t = e.width - e.height * o);
        ...
        n.isVerticallyCentered
          ? (a = (e.height - e.width / o) / 2)
          : n.isBottom && (a = e.height - e.width / o);
    ...
    getRotation: function (e) {
      return (e ? this._degreesSpring.current : this._degreesSpring.target)
        .value;
    },
    setRotation: function (e, t) {
      if (
    ...
    _updateAjaxHeaders: function (e) {
      void 0 === e && (e = !0);
      y.isPlainObject(this.viewer.ajaxHeaders)
        ? (this.ajaxHeaders = y.extend(
            {},
        ...
        for (var n in this.tilesMatrix) {
          ...
          for (var o in this.tilesMatrix[n]) {
            ...
            for (var r in this.tilesMatrix[n][o]) {
              s = (t.y + (r % t.y)) % t.y;
              (r = this.tilesMatrix[n][o][r]).loadWithAjax =
    ...
    _getLevelsInterval: function () {
      ...
      t = Math.min(
        ...
        Math.abs(Math.floor(Math.log(t / this.minPixelRatio) / Math.log(2)))
      );
    ...
    _updateViewport: function () {
      ...
      for (var a = i; n <= a; a--) {
        var l = !1;
        var h =
          e.deltaPixelsFromPointsNoRotate(this.source.getPixelRatio(a), !0).x *
          this._scaleSpring.current.value;
        if (a === n || (!r && h >= this.minPixelRatio)) r = l = !0;
        else if (!r) continue;
        var c =
          e.deltaPixelsFromPointsNoRotate(this.source.getPixelRatio(a), !1).x *
          this._scaleSpring.current.value;
        var u =
    ...
    _updateLevel: function (e, t, i, n, o, r, s, a) {
      ...
      for (var g = c.x; g <= u.x; g++)
        for (var m = c.y; m <= u.y; m++) {
          ...
          null !== r.intersection(this.getTileBounds(i, v, m)) &&
            (a = this._updateTile(t, e, v, m, i, n, o, p, d, s, a));
        }
      return a;
    },
    _updateTile: function (e, t, i, n, o, r, s, a, l, h, c) {
      var u = this._getTile(
        ...
        l = t;
      this.viewer &&
        this.viewer.raiseEvent("update-tile", { tiledImage: this, tile: u });
      this._setCoverage(this.coverage, o, i, n, !1);
      t =
        u.loaded || u.loading || this._isCovered(this.loadingCoverage, o, i, n);
      ...
      u.loaded
        ? this._blendTile(u, i, n, o, r, h) && (this._needsDraw = !0)
        : u.loading
        ? this._tilesLoading++
        : t || (c = this._compareTiles(c, u));
      return c;
    },
    _getTile: function (e, t, i, n, o, r, s) {
      ...
      if (!v[i][e][t] || !v[i][e][t].flipped != !this.flipped) {
        ...
        if (this.loadTilesWithAjax) {
          ...
          y.isPlainObject(this.ajaxHeaders) &&
            (p = y.extend({}, this.ajaxHeaders, p));
        } else p = null;
        ...
        m = new y.Tile(
          ...
          c,
          m,
          f.getTileHashKey(i, a, l, d, p, m)
        );
        this.getFlip()
          ? 0 == a && (m.isRightMost = !0)
          : a == o.x - 1 && (m.isRightMost = !0);
    ...
    _setTileLoaded: function (e, t, i, n) {
      ...
      function a() {
        r &&
          y.console.error(
            "Event 'tile-loaded' argument getCompletionCallback must be called synchronously. Its return value should be called asynchronously."
          );
        o++;
        return l;
      }
      function l() {
        if (0 === --o) {
          e.loading = !1;
          e.loaded = !0;
          e.hasTransparency = s.source.hasTransparency(
            e.context2D,
            e.getUrl(),
            e.ajaxHeaders,
            e.postData
    ...
    _compareTiles: function (e, t) {
      return !e ||
        ...
        (t.visibility === e.visibility && t.squaredDistance < e.squaredDistance)
        ? t
        : e;
    },
    _drawTiles: function (e) {
      if (0 !== this.opacity && (0 !== e.length || this.placeholderFillStyle)) {
        ...
        if (
          ...
          o = t.getTranslationForEdgeSmoothing(
            n,
          ...
          if (!n) {
            ...
            this._drawer.viewer.viewport.getFlip() &&
              ((this.viewport.getRotation(!0) % 360 == 0 &&
                this.getRotation(!0) % 360 == 0) ||
                (a.x =
                  this._drawer.viewer.container.clientWidth - (a.x + a.width)));
            ...
            var h = this._croppingPolygons.map(function (e) {
              return e.map(function (e) {
                e = l
                  ...
                  .rotate(-l.getRotation(!0), l._getRotationPoint(!0));
        ...
        var u = !1;
        c === y.SUBPIXEL_ROUNDING_OCCURRENCES.ALWAYS
          ? (u = !0)
          : c === y.SUBPIXEL_ROUNDING_OCCURRENCES.ONLY_AT_REST &&
            (u = !(this.viewer && this.viewer.isAnimating()));
        for (var d = e.length - 1; 0 <= d; d--) {
          ...
          t.beingDrawn = !0;
          this.viewer &&
            this.viewer.raiseEvent("tile-drawn", { tiledImage: this, tile: t });
        }
        r && this._drawer.restoreContext(i);
        if (!n) {
          this.getRotation(!0) % 360 != 0 &&
            this._drawer._restoreRotationChanges(i);
          this.viewport.getRotation(!0) % 360 != 0 &&
            this._drawer._restoreRotationChanges(i);
        }
        if (i) {
  ...
  function g(e) {
    return (
      e !== y.SUBPIXEL_ROUNDING_OCCURRENCES.ALWAYS &&
      e !== y.SUBPIXEL_ROUNDING_OCCURRENCES.ONLY_AT_REST &&
      e !== y.SUBPIXEL_ROUNDING_OCCURRENCES.NEVER
    );
  }
  function m(e) {
    return g(e) ? p : e;
...
!(function (g) {
  ...
  g.TileCache = function (e) {
    this._maxImageCacheCount =
      (e = e || {}).maxImageCacheCount || g.DEFAULT_SETTINGS.maxImageCacheCount;
    this._tilesLoaded = [];
    this._imagesLoaded = [];
    ...
    cacheTile: function (e) {
      ...
      if (this._imagesLoadedCount > this._maxImageCacheCount) {
        ...
        for (var p = this._tilesLoaded.length - 1; 0 <= p; p--)
          if (
            !((a = (d = this._tilesLoaded[p]).tile).level <= t || a.beingDrawn)
          )
            if (o) {
              c = a.lastTouchTime;
              l = o.lastTouchTime;
  ...
  g.extend(g.World.prototype, g.EventSource.prototype, {
    ...
    arrange: function (e) {
      ...
      for (var p = 0; p < this._items.length; p++) {
        ...
        d =
          (u =
            (d = (c = this._items[p]).getBounds()).width > d.height
              ? r
              : r * (d.width / d.height)) *
          (d.height / d.width);
    ...
    _figureSizes: function () {
      ...
      (this._contentFactor === i &&
        this._homeBounds.equals(e) &&
